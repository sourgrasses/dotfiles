...
hi! ColorColumn cterm=NONE ctermbg=238 guibg=#303030
hi! CursorColumn cterm=NONE ctermbg=238 guibg=#303030
hi! CursorLine cterm=NONE ctermbg=238 guibg=#303030
hi! Comment ctermfg=244 guifg=#808080
hi! Constant ctermfg=158 guifg=#afffd7
hi! Cursor ctermbg=255 ctermfg=236 guibg=#eeeeee guifg=#303030
hi! CursorLineNr ctermbg=238 ctermfg=218 guibg=#303030 guifg=#ffafd7
...
hi! LineNr ctermbg=238 ctermfg=245 guibg=#303030 guifg=#8a8a8a
hi! MatchParen ctermbg=153 ctermfg=236 guibg=#303030 guifg=#d7d7ff
...
hi! Search ctermbg=59 ctermfg=255 guibg=#f082b9 guifg=#303030
...
hi! ALEWarningSign ctermbg=238 ctermfg=216 guibg=#444444 guifg=#d7d7ff
hi! ALEVirtualTextError ctermfg=216 guifg=#ffaf87
hi! ALEVirtualTextWarning ctermfg=216 guifg=#d7d7ff
